...
class SmsClient {
    ...
    sendMessage(message) {
        ...
        var okresponseFunc = (responseContent) => {
            return parseInt(this.#getValueFromListResponseContent(responseContent, this.#messageIdPropertyName));
        }
    ...
    getBalance() {
        ...
        var okResultFunc = (responseContent) => {
        ...
        return this.#makeHttpRequest(url, okResultFunc);
    }

    #makeHttpRequest(url, okResultFunc) {
